    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_key', openedx.core.djangoapps.xmodule_django.models.CourseKeyField(help_text=b'Which course is this group associated with', max_length=255, db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('course_key', openedx.core.djangoapps.xmodule_django.models.CourseKeyField(unique=True, max_length=255, db_index=True)),
                ('is_shift_enabled', models.BooleanField(default=False, help_text=b'True value if this feature is enabled for the course run')),
                ('is_autostart', models.BooleanField(default=True, help_text=b'Are groups generated automatically with period or according to the manually set plan')),
